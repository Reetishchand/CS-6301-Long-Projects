...
public class RedBlackTree<T extends Comparable<? super T>> extends BinarySearchTree<T> {
     ...
     */
    protected void leftRotate(BinarySearchTree.Entry<T> x){
        ...
        BinarySearchTree.Entry<T> parent = parent(x);
     ...
     */
    protected void rightRotate(BinarySearchTree.Entry<T> x){
    ...
    public static void main(String[] args) {
        ...
        for (int i = 1; i <= 64000000; i++) rbTree.add(i);
